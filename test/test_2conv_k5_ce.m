...
static void test(const char *dev){
    ...
    u32 ff=32*10*10; Term lw=mkw(ctx,SHAPE(ff,10),ff),lb=mkz(ctx,10);
    ...
    BNResult bn=batchnorm_forward(ctx,h,bn_g,bn_b,bn_rm,bn_rv,BS,32,20,20,1);
    ...
    #define NP 4
    Term params[NP]={cw1,cb1,cw2,cb2};u32 psz[NP]={32*25,32,32*32*25,32};
