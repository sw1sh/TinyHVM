...
int main(void) {
    ...
    f32*r1=thvm_to_host(ctx,h);
    printf("fused pool: [%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f]\n",
    ...
    f32*r2=thvm_to_host(ctx,h);
    printf("nofuse pool: [%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f]\n",
        r2[0],r2[1],r2[2],r2[3],r2[4],r2[5],r2[6],r2[7]);
    f32 d=0; for(int i=0;i<16;i++){f32 dd=fabsf(r1[i]-r2[i]);if(dd>d)d=dd;}
