...
TINetGraphImport::usage = "TINetGraphImport[tensor|term|snapshot] renders the pure-WL heap-walk DOT generated by TINetGraphDOT through ImportDOT. ImportDOT options can be passed through.";
